...
/* Variaveis de resultado do sensor */
...
{   
    ...
    if(distance < 10) {
      MQTT.publish(TOPICO_PUBLISH, "Vaga ocupada!");
      digitalWrite(13, LOW);
      digitalWrite(25, HIGH);
    } else{
      MQTT.publish(TOPICO_PUBLISH, "Vaga liberada!");
      digitalWrite(25, LOW);
